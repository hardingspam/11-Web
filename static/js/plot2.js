...
let margin = {top: 70, right: 0, bottom: 30, left: 10};
...
function updateBars(group) {
  ...
  if (group == 2016) {
    endpoint = "/volumes-2016"
  }
  if (group == 2017) {
    endpoint = "/volumes-2017"
  }
  if (group == 2018) {
    endpoint = "/volumes-2018"
  }
  ...
  d3.json(endpoint).then((data) => {
    ...
    y.domain([0, d3.max(discharges, function(d) { return d; })]);
    ...
    svg.append("g")
        ...
        .call(d3.axisLeft(y).ticks(5).tickValues([100, 200, 300, 400, 500]));
